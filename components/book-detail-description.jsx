...
class BookDetailDescription extends React.Component {
  render() {
    ...
    return (
      <div className="book-details-container row" id={bookDetail.id}>
        <div className="col-4">
        ...
        <div className="col-8">
          <div className="author-details d-inline-block">
            ...
            <div
              className="book-description ml-4"
            ...
            <div className="ratings-container">
              ...
              <span className="rating-details">
                Rating Details &nbsp;.&nbsp; {bookDetail.ratings_count} Ratings
                &nbsp;.&nbsp; {bookDetail.text_reviews_count} Reviews
              </span>
            </div>
          </div>
        </div>
